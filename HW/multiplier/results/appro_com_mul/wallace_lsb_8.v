...
module wallace_lsb_8 ( a, b, sum );
  ...
  fa_218 FA_2 ( .s(SF_2), .cout(CF_2), .a(P_15_2), .b(P_14_3), .cin(CO_14) );
  fa_217 FA_3 ( .s(SF_3), .cout(CF_3), .a(P_2_4), .b(P_1_5), .cin(P_0_6) );
  fa_216 FA_4 ( .s(SF_4), .cout(CF_4), .a(P_15_6), .b(P_14_7), .cin(CO_28) );
  fa_215 FA_5 ( .s(SF_5), .cout(CF_5), .a(P_2_8), .b(P_1_9), .cin(P_0_10) );
  fa_214 FA_6 ( .s(SF_6), .cout(CF_6), .a(P_15_10), .b(P_14_11), .cin(CO_42)
         );
  fa_213 FA_7 ( .s(SF_7), .cout(CF_7), .a(P_2_12), .b(P_1_13), .cin(P_0_14) );
  fa_212 FA_8 ( .s(SF_8), .cout(CF_8), .a(P_15_14), .b(P_14_15), .cin(CO_56)
         );
  cp_app_0 CP_1 ( .sum(SC_1), .cout(CO_1), .carry(CC_1), .x1(P_3_0), .x2(P_2_1), .x3(P_1_2), .x4(P_0_3), .cin(1'b0) );
  cp_app_7 CP_2 ( .sum(SC_2), .cout(CO_2), .carry(CC_2), .x1(P_4_0), .x2(P_3_1), .x3(P_2_2), .x4(P_1_3), .cin(CO_1) );
  cp_app_6 CP_3 ( .sum(SC_3), .cout(CO_3), .carry(CC_3), .x1(P_5_0), .x2(P_4_1), .x3(P_3_2), .x4(P_2_3), .cin(CO_2) );
  cp_app_5 CP_4 ( .sum(SC_4), .cout(CO_4), .carry(CC_4), .x1(P_6_0), .x2(P_5_1), .x3(P_4_2), .x4(P_3_3), .cin(CO_3) );
  cp_app_4 CP_5 ( .sum(SC_5), .cout(CO_5), .carry(CC_5), .x1(P_7_0), .x2(P_6_1), .x3(P_5_2), .x4(P_4_3), .cin(CO_4) );
  cp_acc_0 CP_6 ( .sum(SC_6), .cout(CO_6), .carry(CC_6), .x1(P_8_0), .x2(P_7_1), .x3(P_6_2), .x4(P_5_3), .cin(CO_5) );
  cp_acc_86 CP_7 ( .sum(SC_7), .cout(CO_7), .carry(CC_7), .x1(P_9_0), .x2(
        P_8_1), .x3(P_7_2), .x4(P_6_3), .cin(CO_6) );
  cp_acc_85 CP_8 ( .sum(SC_8), .cout(CO_8), .carry(CC_8), .x1(P_10_0), .x2(
        P_9_1), .x3(P_8_2), .x4(P_7_3), .cin(CO_7) );
  cp_acc_84 CP_9 ( .sum(SC_9), .cout(CO_9), .carry(CC_9), .x1(P_11_0), .x2(
        P_10_1), .x3(P_9_2), .x4(P_8_3), .cin(CO_8) );
  cp_acc_83 CP_10 ( .sum(SC_10), .cout(CO_10), .carry(CC_10), .x1(P_12_0), 
        .x2(P_11_1), .x3(P_10_2), .x4(P_9_3), .cin(CO_9) );
  cp_acc_82 CP_11 ( .sum(SC_11), .cout(CO_11), .carry(CC_11), .x1(P_13_0), 
        .x2(P_12_1), .x3(P_11_2), .x4(P_10_3), .cin(CO_10) );
  cp_acc_81 CP_12 ( .sum(SC_12), .cout(CO_12), .carry(CC_12), .x1(P_14_0), 
        .x2(P_13_1), .x3(P_12_2), .x4(P_11_3), .cin(CO_11) );
  cp_acc_80 CP_13 ( .sum(SC_13), .cout(CO_13), .carry(CC_13), .x1(P_15_0), 
        .x2(P_14_1), .x3(P_13_2), .x4(P_12_3), .cin(CO_12) );
  cp_acc_79 CP_14 ( .sum(SC_14), .cout(CO_14), .carry(CC_14), .x1(P_15_1), 
        .x2(P_14_2), .x3(P_13_3), .x4(1'b0), .cin(CO_13) );
  cp_app_3 CP_15 ( .sum(SC_15), .cout(CO_15), .carry(CC_15), .x1(P_3_4), .x2(
        P_2_5), .x3(P_1_6), .x4(P_0_7), .cin(1'b0) );
  cp_acc_78 CP_16 ( .sum(SC_16), .cout(CO_16), .carry(CC_16), .x1(P_4_4), .x2(
        P_3_5), .x3(P_2_6), .x4(P_1_7), .cin(CO_15) );
  cp_acc_77 CP_17 ( .sum(SC_17), .cout(CO_17), .carry(CC_17), .x1(P_5_4), .x2(
        P_4_5), .x3(P_3_6), .x4(P_2_7), .cin(CO_16) );
  cp_acc_76 CP_18 ( .sum(SC_18), .cout(CO_18), .carry(CC_18), .x1(P_6_4), .x2(
        P_5_5), .x3(P_4_6), .x4(P_3_7), .cin(CO_17) );
  cp_acc_75 CP_19 ( .sum(SC_19), .cout(CO_19), .carry(CC_19), .x1(P_7_4), .x2(
        P_6_5), .x3(P_5_6), .x4(P_4_7), .cin(CO_18) );
  cp_acc_74 CP_20 ( .sum(SC_20), .cout(CO_20), .carry(CC_20), .x1(P_8_4), .x2(
        P_7_5), .x3(P_6_6), .x4(P_5_7), .cin(CO_19) );
  cp_acc_73 CP_21 ( .sum(SC_21), .cout(CO_21), .carry(CC_21), .x1(P_9_4), .x2(
        P_8_5), .x3(P_7_6), .x4(P_6_7), .cin(CO_20) );
  cp_acc_72 CP_22 ( .sum(SC_22), .cout(CO_22), .carry(CC_22), .x1(P_10_4), 
        .x2(P_9_5), .x3(P_8_6), .x4(P_7_7), .cin(CO_21) );
  cp_acc_71 CP_23 ( .sum(SC_23), .cout(CO_23), .carry(CC_23), .x1(P_11_4), 
        .x2(P_10_5), .x3(P_9_6), .x4(P_8_7), .cin(CO_22) );
  cp_acc_70 CP_24 ( .sum(SC_24), .cout(CO_24), .carry(CC_24), .x1(P_12_4), 
        .x2(P_11_5), .x3(P_10_6), .x4(P_9_7), .cin(CO_23) );
  cp_acc_69 CP_25 ( .sum(SC_25), .cout(CO_25), .carry(CC_25), .x1(P_13_4), 
        .x2(P_12_5), .x3(P_11_6), .x4(P_10_7), .cin(CO_24) );
  cp_acc_68 CP_26 ( .sum(SC_26), .cout(CO_26), .carry(CC_26), .x1(P_14_4), 
        .x2(P_13_5), .x3(P_12_6), .x4(P_11_7), .cin(CO_25) );
  cp_acc_67 CP_27 ( .sum(SC_27), .cout(CO_27), .carry(CC_27), .x1(P_15_4), 
        .x2(P_14_5), .x3(P_13_6), .x4(P_12_7), .cin(CO_26) );
  cp_acc_66 CP_28 ( .sum(SC_28), .cout(CO_28), .carry(CC_28), .x1(P_15_5), 
        .x2(P_14_6), .x3(P_13_7), .x4(1'b0), .cin(CO_27) );
  cp_acc_65 CP_29 ( .sum(SC_29), .cout(CO_29), .carry(CC_29), .x1(P_3_8), .x2(
        P_2_9), .x3(P_1_10), .x4(P_0_11), .cin(1'b0) );
  cp_acc_64 CP_30 ( .sum(SC_30), .cout(CO_30), .carry(CC_30), .x1(P_4_8), .x2(
        P_3_9), .x3(P_2_10), .x4(P_1_11), .cin(CO_29) );
  cp_acc_63 CP_31 ( .sum(SC_31), .cout(CO_31), .carry(CC_31), .x1(P_5_8), .x2(
        P_4_9), .x3(P_3_10), .x4(P_2_11), .cin(CO_30) );
  cp_acc_62 CP_32 ( .sum(SC_32), .cout(CO_32), .carry(CC_32), .x1(P_6_8), .x2(
        P_5_9), .x3(P_4_10), .x4(P_3_11), .cin(CO_31) );
  cp_acc_61 CP_33 ( .sum(SC_33), .cout(CO_33), .carry(CC_33), .x1(P_7_8), .x2(
        P_6_9), .x3(P_5_10), .x4(P_4_11), .cin(CO_32) );
  cp_acc_60 CP_34 ( .sum(SC_34), .cout(CO_34), .carry(CC_34), .x1(P_8_8), .x2(
        P_7_9), .x3(P_6_10), .x4(P_5_11), .cin(CO_33) );
  cp_acc_59 CP_35 ( .sum(SC_35), .cout(CO_35), .carry(CC_35), .x1(P_9_8), .x2(
        P_8_9), .x3(P_7_10), .x4(P_6_11), .cin(CO_34) );
  cp_acc_58 CP_36 ( .sum(SC_36), .cout(CO_36), .carry(CC_36), .x1(P_10_8), 
        .x2(P_9_9), .x3(P_8_10), .x4(P_7_11), .cin(CO_35) );
  cp_acc_57 CP_37 ( .sum(SC_37), .cout(CO_37), .carry(CC_37), .x1(P_11_8), 
        .x2(P_10_9), .x3(P_9_10), .x4(P_8_11), .cin(CO_36) );
  cp_acc_56 CP_38 ( .sum(SC_38), .cout(CO_38), .carry(CC_38), .x1(P_12_8), 
        .x2(P_11_9), .x3(P_10_10), .x4(P_9_11), .cin(CO_37) );
  cp_acc_55 CP_39 ( .sum(SC_39), .cout(CO_39), .carry(CC_39), .x1(P_13_8), 
        .x2(P_12_9), .x3(P_11_10), .x4(P_10_11), .cin(CO_38) );
  cp_acc_54 CP_40 ( .sum(SC_40), .cout(CO_40), .carry(CC_40), .x1(P_14_8), 
        .x2(P_13_9), .x3(P_12_10), .x4(P_11_11), .cin(CO_39) );
  cp_acc_53 CP_41 ( .sum(SC_41), .cout(CO_41), .carry(CC_41), .x1(P_15_8), 
        .x2(P_14_9), .x3(P_13_10), .x4(P_12_11), .cin(CO_40) );
  cp_acc_52 CP_42 ( .sum(SC_42), .cout(CO_42), .carry(CC_42), .x1(P_15_9), 
        .x2(P_14_10), .x3(P_13_11), .x4(1'b0), .cin(CO_41) );
  cp_acc_51 CP_43 ( .sum(SC_43), .cout(CO_43), .carry(CC_43), .x1(P_3_12), 
        .x2(P_2_13), .x3(P_1_14), .x4(P_0_15), .cin(1'b0) );
  cp_acc_50 CP_44 ( .sum(SC_44), .cout(CO_44), .carry(CC_44), .x1(P_4_12), 
        .x2(P_3_13), .x3(P_2_14), .x4(P_1_15), .cin(CO_43) );
  cp_acc_49 CP_45 ( .sum(SC_45), .cout(CO_45), .carry(CC_45), .x1(P_5_12), 
        .x2(P_4_13), .x3(P_3_14), .x4(P_2_15), .cin(CO_44) );
  cp_acc_48 CP_46 ( .sum(SC_46), .cout(CO_46), .carry(CC_46), .x1(P_6_12), 
        .x2(P_5_13), .x3(P_4_14), .x4(P_3_15), .cin(CO_45) );
  cp_acc_47 CP_47 ( .sum(SC_47), .cout(CO_47), .carry(CC_47), .x1(P_7_12), 
        .x2(P_6_13), .x3(P_5_14), .x4(P_4_15), .cin(CO_46) );
  cp_acc_46 CP_48 ( .sum(SC_48), .cout(CO_48), .carry(CC_48), .x1(P_8_12), 
        .x2(P_7_13), .x3(P_6_14), .x4(P_5_15), .cin(CO_47) );
  cp_acc_45 CP_49 ( .sum(SC_49), .cout(CO_49), .carry(CC_49), .x1(P_9_12), 
        .x2(P_8_13), .x3(P_7_14), .x4(P_6_15), .cin(CO_48) );
  cp_acc_44 CP_50 ( .sum(SC_50), .cout(CO_50), .carry(CC_50), .x1(P_10_12), 
        .x2(P_9_13), .x3(P_8_14), .x4(P_7_15), .cin(CO_49) );
  cp_acc_43 CP_51 ( .sum(SC_51), .cout(CO_51), .carry(CC_51), .x1(P_11_12), 
        .x2(P_10_13), .x3(P_9_14), .x4(P_8_15), .cin(CO_50) );
  cp_acc_42 CP_52 ( .sum(SC_52), .cout(CO_52), .carry(CC_52), .x1(P_12_12), 
        .x2(P_11_13), .x3(P_10_14), .x4(P_9_15), .cin(CO_51) );
  cp_acc_41 CP_53 ( .sum(SC_53), .cout(CO_53), .carry(CC_53), .x1(P_13_12), 
        .x2(P_12_13), .x3(P_11_14), .x4(P_10_15), .cin(CO_52) );
  cp_acc_40 CP_54 ( .sum(SC_54), .cout(CO_54), .carry(CC_54), .x1(P_14_12), 
        .x2(P_13_13), .x3(P_12_14), .x4(P_11_15), .cin(CO_53) );
  cp_acc_39 CP_55 ( .sum(SC_55), .cout(CO_55), .carry(CC_55), .x1(P_15_12), 
        .x2(P_14_13), .x3(P_13_14), .x4(P_12_15), .cin(CO_54) );
  cp_acc_38 CP_56 ( .sum(SC_56), .cout(CO_56), .carry(CC_56), .x1(P_15_13), 
  ...
  fa_211 FA_9 ( .s(SF_9), .cout(CF_9), .a(1'b0), .b(CC_1), .cin(P_0_4) );
  fa_210 FA_10 ( .s(SF_10), .cout(CF_10), .a(1'b0), .b(CC_2), .cin(SH_2) );
  fa_209 FA_11 ( .s(SF_11), .cout(CF_11), .a(SC_27), .b(CC_26), .cin(CO_69) );
  fa_208 FA_12 ( .s(SF_12), .cout(CF_12), .a(SC_30), .b(CC_29), .cin(P_0_12)
         );
  fa_207 FA_13 ( .s(SF_13), .cout(CF_13), .a(SC_31), .b(CC_30), .cin(SH_4) );
  fa_206 FA_14 ( .s(SF_14), .cout(CF_14), .a(SC_55), .b(CC_54), .cin(CO_83) );
  cp_app_2 CP_57 ( .sum(SC_57), .cout(CO_57), .carry(CC_57), .x1(1'b0), .x2(
        CC_3), .x3(SF_3), .x4(CH_2), .cin(1'b0) );
  cp_app_1 CP_58 ( .sum(SC_58), .cout(CO_58), .carry(CC_58), .x1(1'b0), .x2(
  ...
  fa_205 FA_15 ( .s(SF_15), .cout(CF_15), .a(SC_59), .b(CC_58), .cin(P_0_8) );
  fa_204 FA_16 ( .s(SF_16), .cout(CF_16), .a(SC_60), .b(CC_59), .cin(SH_3) );
  fa_203 FA_17 ( .s(SF_17), .cout(CF_17), .a(SC_61), .b(CC_60), .cin(SH_10) );
  fa_202 FA_18 ( .s(SF_18), .cout(CF_18), .a(SC_81), .b(CC_80), .cin(CO_96) );
  ...
  fa_201 FA_20 ( .s(sum[5]), .cout(CF_27), .a(SH_17), .b(CH_16), .cin(CF_26)
         );
  fa_200 FA_21 ( .s(sum[6]), .cout(CF_28), .a(SH_18), .b(CH_17), .cin(CF_27)
         );
  fa_199 FA_22 ( .s(sum[7]), .cout(CF_29), .a(SH_19), .b(CH_18), .cin(CF_28)
         );
  fa_198 FA_23 ( .s(sum[8]), .cout(CF_30), .a(SF_15), .b(CH_19), .cin(CF_29)
         );
  fa_197 FA_24 ( .s(sum[9]), .cout(CF_31), .a(SF_16), .b(CF_15), .cin(CF_30)
         );
  fa_196 FA_25 ( .s(sum[10]), .cout(CF_32), .a(SF_17), .b(CF_16), .cin(CF_31)
         );
  fa_195 FA_26 ( .s(sum[11]), .cout(CF_33), .a(SC_84), .b(CF_17), .cin(CF_32)
         );
  fa_194 FA_27 ( .s(sum[12]), .cout(CF_34), .a(SC_85), .b(CC_84), .cin(CF_33)
         );
  fa_193 FA_28 ( .s(sum[13]), .cout(CF_35), .a(SC_86), .b(CC_85), .cin(CF_34)
         );
  fa_192 FA_29 ( .s(sum[14]), .cout(CF_36), .a(SC_87), .b(CC_86), .cin(CF_35)
         );
  fa_191 FA_30 ( .s(sum[15]), .cout(CF_37), .a(SC_88), .b(CC_87), .cin(CF_36)
         );
  fa_190 FA_31 ( .s(sum[16]), .cout(CF_38), .a(SC_89), .b(CC_88), .cin(CF_37)
         );
  fa_189 FA_32 ( .s(sum[17]), .cout(CF_39), .a(SC_90), .b(CC_89), .cin(CF_38)
         );
  fa_188 FA_33 ( .s(sum[18]), .cout(CF_40), .a(SC_91), .b(CC_90), .cin(CF_39)
         );
  fa_187 FA_34 ( .s(sum[19]), .cout(CF_41), .a(SC_92), .b(CC_91), .cin(CF_40)
         );
  fa_186 FA_35 ( .s(sum[20]), .cout(CF_42), .a(SC_93), .b(CC_92), .cin(CF_41)
         );
  fa_185 FA_36 ( .s(sum[21]), .cout(CF_43), .a(SC_94), .b(CC_93), .cin(CF_42)
         );
  fa_184 FA_37 ( .s(sum[22]), .cout(CF_44), .a(SC_95), .b(CC_94), .cin(CF_43)
         );
  fa_183 FA_38 ( .s(sum[23]), .cout(CF_45), .a(SC_96), .b(CC_95), .cin(CF_44)
         );
  fa_182 FA_39 ( .s(sum[24]), .cout(CF_46), .a(SF_18), .b(CC_96), .cin(CF_45)
         );
  fa_181 FA_40 ( .s(sum[25]), .cout(CF_47), .a(SH_20), .b(CF_18), .cin(CF_46)
         );
  fa_180 FA_41 ( .s(sum[26]), .cout(CF_48), .a(SH_21), .b(CH_20), .cin(CF_47)
         );
  fa_179 FA_42 ( .s(sum[27]), .cout(CF_49), .a(SH_22), .b(CH_21), .cin(CF_48)
         );
  fa_178 FA_43 ( .s(sum[28]), .cout(CF_50), .a(SH_23), .b(CH_22), .cin(CF_49)
         );
  fa_177 FA_44 ( .s(sum[29]), .cout(CF_51), .a(SH_24), .b(CH_23), .cin(CF_50)
         );
  fa_176 FA_45 ( .s(sum[30]), .cout(CF_52), .a(SH_25), .b(CH_24), .cin(CF_51)
         );
  fa_175 FA_46 ( .s(sum[31]), .a(CH_25), .b(CH_14), .cin(CF_52) );
